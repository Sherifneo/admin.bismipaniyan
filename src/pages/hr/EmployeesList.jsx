...
import { employeesApi, locationsApi } from "../../api/admin";
  ...
  return (
    <Modal title={isEdit ? `Edit — ${employee.full_name}` : "Add employee"} onClose={onClose}>
      <form onSubmit={submit} className="bp-form">
        ...
        <div className="bp-form-row">
          <div style={{ flex: 1 }}>
            <label className="bp-field-label" htmlFor="eRole">Role / designation</label>
            <input id="eRole" type="text" className="bp-field-input" placeholder="e.g. Baker, Packer, Helper" value={roleDesignation} onChange={(ev) => setRoleDesignation(ev.target.value)} />
          </div>
          <div style={{ flex: 1 }}>
